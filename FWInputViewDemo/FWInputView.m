...
- (void)textViewTextDidChangeNotification:(NSNotification *)not
{
    ...
    CGSize sizeFrame = [textView.text boundingRectWithSize:constraintSize
                                                   options:NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:textView.font}
                                                   context:nil].size;
